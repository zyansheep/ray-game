...
use bevy::{diagnostic::{FrameTimeDiagnosticsPlugin, LogDiagnosticsPlugin}, input::mouse::MouseMotion, prelude::*, reflect::TypeUuid, render::{
		camera::Camera,
...
fn setup(
	...
	render_graph.add_system_node(
		"ray_uniform",
		RenderResourcesNode::<RayUniform>::new(true),
	);
